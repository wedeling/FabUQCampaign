...
trace_prob_E, tmp1, tmp2 = qmc_analysis._separate_output_values(data['trace_prob_E',0], n_params, n_runs)

trace_rate_I, tmp1, tmp2 = qmc_analysis._separate_output_values(data['trace_rate_I',0], n_params, n_runs)

trace_contact_reduction, tmp1, tmp2 = qmc_analysis._separate_output_values(data['trace_contact_reduction',0], n_params, n_runs)
...
plt.tight_layout()
f.savefig('figures/Fig5_heatmap_CT_IC_prev.eps')
...
plt.tight_layout()
#f.savefig('figures/heatmap_CT_IC_ex.eps')
...
plt.tight_layout()
#f.savefig('figures/heatmap_CT.eps')
